...
class Arcana {
  Arcana._(
      ...
      arcanaAllSymbols,
      arcanaMainColor,
      arcanaSecondaryColor,
      arcanaTertiaryColor,
      arcanaImage,
      pastPositionArcanaDescription,
      presentPositionArcanaDescription,
      futurePositionArcanaDescription);
  String arcanaName;
  String arcanaShortSymbols;
  String arcanaAllSymbols;
  String pastPositionArcanaDescription;
  String presentPositionArcanaDescription;
  String futurePositionArcanaDescription;
  Color arcanaMainColor;
  Color arcanaSecondaryColor;
  Color arcanaTertiaryColor;
  AssetImage arcanaImage;
  static GlobalKey _titleKey = GlobalKey();
  static const AssetImage CARD_BACK = AssetImage('assets/cards/Back.png');
  static const List<String> POSITIONS_NAMES = [
    "Passé",
    "Présent",
    "Futur",
  ];

  static Arcana bole = Arcana._(
    "Le Tronc",
  ...
  static Arcana balance = Arcana._(
    "La Balance",
    "Justice & prospérité",
  ...
  static Arcana reverseArrow = Arcana._(
    "La Flèche renversée",
  ...
  static Arcana reverseSpear = Arcana._(    "L'Epieu renversé", 
    "Epreuve & vengeance",
